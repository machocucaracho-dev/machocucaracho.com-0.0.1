...
const apiKey = 'TWM7VGVZQQ6IF9911C5AP3Z4IJ9N6YDUDI';//process.env.REACT_APP_ETHERSCAN_API_KEY;
    ...
    for (let i = 0; i < 5; i = i + 1) {
      ...
      blocks.push(
        <Table.Row key={i}>
          ...
          <Table.Cell>
            Miner {result.miner ? result.miner : -99} <br></br>
            Txs {(result.transactions ? result.transactions.length : -99)}
          </Table.Cell>
          <Table.Cell>
